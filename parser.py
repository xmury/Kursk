def parser(doc_text):	
	...
	for w in doc_text:
		...
		if w == "<" and f_1 == True and f_2 == False: f_2 = True

		# Если в теле тега много других тегов. Когда проверяем будет ли этот тег нашим закрывающим тегом
		if w == "<" and f_2 == True: c_teg = "";
